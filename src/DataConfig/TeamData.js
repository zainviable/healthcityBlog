// ***** non-clinical team image *****
import member1NC from "../assets/img/non-clinical/cletus.jpg";
// import member2NC from "../assets/img/non-clinical/4.jpg";
import member3NC from "../assets/img/non-clinical/robert.jpg";
import member4NC from "../assets/img/non-clinical/seikegba.jpg";
...
import member5C from "../assets/img/clinical/manminder.jpeg";
import member6C from "../assets/img/clinical/ellen.jpg";
import member7C from "../assets/img/clinical/federica.jpg";
import member8C from "../assets/img/clinical/vandy.png";
import member9C from "../assets/img/clinical/layton.jpeg";
import member10C from "../assets/img/clinical/shuja.jpeg";
import member11C from "../assets/img/clinical/eva.jpg";
import member12C from "../assets/img/clinical/edward.png";
import member13C from "../assets/img/clinical/daniel.jpg";
import member14C from "../assets/img/clinical/cristina.jpeg";
import member15C from "../assets/img/clinical/anna.jpg";
// import member16C from "../assets/img/clinical/4.jpg";
import member17C from "../assets/img/clinical/emma.png";
import member18C from "../assets/img/clinical/devi.png";
import member19C from "../assets/img/clinical/deborah.jpg";
import member20C from "../assets/img/clinical/caroline.jpg";
import member21C from "../assets/img/clinical/katali.jpg";
import member22C from "../assets/img/clinical/gail.jpg";
import member23C from "../assets/img/clinical/monika.jpg";
import member24C from "../assets/img/clinical/marais.jpg";
import member25C from "../assets/img/clinical/beatrice.jpg";
import member26C from "../assets/img/clinical/mark.jpg";
import member27C from "../assets/img/clinical/kay.jpg";
import member28C from "../assets/img/clinical/natalia.jpg";
import member29C from "../assets/img/clinical/lucy.png";
import member30C from "../assets/img/clinical/sian.jpg";
import member31C from "../assets/img/clinical/dinah.jpg";
import member32C from "../assets/img/clinical/ray.jpg";
import member33C from "../assets/img/clinical/naima.jpg";
import member34C from "../assets/img/clinical/farida.jpg";
import member35C from "../assets/img/clinical/lindita.jpg";
import member36C from "../assets/img/clinical/sonya.jpg";
import member37C from "../assets/img/clinical/blanco.jpg";
import member38C from "../assets/img/clinical/vincent.jpg";
...
const clinicalteamList = [
  {
    id: 1,
    imgUrl: member1C,
    name: "Dr. Francis Selemo, HCPC",
    designation:
      "Consultant Psychologist,  CBT Therapist, Behavioural Couple Therapy (BCT) Practitioner, Long Term Health Conditions Therapy Practitioner",
    detail:
  ...
  },
  {
    ...
    name: "Sonya Tancheya",
    designation:
      "Cognitive Psychologist, Business Psychologist, CBT Practitioner, Research Assistant, Project Manager Cognitive & Experimental  Psychology ( Thinking , Reasoning and Problem Solving, Analogy Making, Memory, Psycholinguistics), UK and overseas.",
    detail:
